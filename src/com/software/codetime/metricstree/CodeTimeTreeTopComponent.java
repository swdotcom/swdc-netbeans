 ...
 */
@ConvertAsProperties(
        dtd = "-//com.software.codetime.metricstree//CodeTimeTreeWindow//EN",
        autostore = false
)
...
@ActionID(category = "Tools", id = "com.software.codetime.metricstree.CodeTimeTreeWindowTopComponent")
